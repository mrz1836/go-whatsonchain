...
func TestClient_BulkTransactionDetails(t *testing.T) {
	...
	resp, err := client.BulkTransactionDetails(hashes)
	if err != nil {
		t.Fatal("error occurred: " + err.Error())
	}
...
func TestClient_GetRawTransactionData(t *testing.T) {
	...
	tx := "c1d32f28baa27a376ba977f6a8de6ce0a87041157cef0274b20bfda2b0d8df96"
	resp, err := client.GetRawTransactionData(tx)
	if err != nil {
		t.Fatal("error occurred: " + err.Error())
	}
...
func TestClient_GetRawTransactionOutputData(t *testing.T) {
	...
	tx := "c1d32f28baa27a376ba977f6a8de6ce0a87041157cef0274b20bfda2b0d8df96"
	resp, err := client.GetRawTransactionOutputData(tx, 0)
	if err != nil {
		t.Fatal("error occurred: " + err.Error())
	}
...
func TestClient_DecodeTransaction(t *testing.T) {
	...
	txHex := ""
	txInfo, err := client.DecodeTransaction(txHex)
	if err != nil {
		t.Fatal("error occurred", err.Error())
	}
	if txInfo == nil {
...
func TestClient_DownloadReceipt(t *testing.T) {
	...
	hash := "c1d32f28baa27a376ba977f6a8de6ce0a87041157cef0274b20bfda2b0d8df96"
	resp, err := client.DownloadReceipt(hash)
	if err != nil {
		t.Fatal("error occurred: " + err.Error())
	}
